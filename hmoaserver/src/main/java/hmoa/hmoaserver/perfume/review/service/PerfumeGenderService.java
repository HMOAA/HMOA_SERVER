...
public class PerfumeGenderService {
    ...
    public PerfumeGenderResponseDto save(String token, Long perfumeId, PerfumeGenderRequestDto dto){
        ...
        if(!isPresentPerfumeGender(member,perfume)){
            ...
            return new PerfumeGenderResponseDto(perfumeReviewService.calculateGender(perfume),true);
        }else {
    ...
    public PerfumeGenderResponseDto delete(Member member, Perfume perfume) {
        ...
        return new PerfumeGenderResponseDto(perfumeReviewService.calculateGender(perfume), false);
    }
